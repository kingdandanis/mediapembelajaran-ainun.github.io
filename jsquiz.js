(function($) {
    ...
    var myColor;
    var all_questions = [{
        question_string: "25 x 6 ?",
        choices: {
            correct: "150",
            wrong: ["100", "160", "250"]
        }
    }, {
        question_string: "500 : 4 ?",
        choices: {
            correct: "125",
            wrong: ["150", "135", "100"]
        }
    }, {
        question_string: "25 x 5 x 9 ?",
        choices: {
            correct: "1125",
            wrong: ["1150", "1200", "1500"]
        }
    }, {
        question_string: '350 + 180 x 63 ?',
        choices: {
            correct: "11.690",
            wrong: ["11.800", "12.546", "13.400"]
        }
    }, {
        question_string: '48.780 - 45 (16.864 : 31) ?',
        choices: {
            correct: "24.300",
            wrong: ["25.000", "27.500", "23.400"]
        }
	}, {
        question_string: '405 + 25 - 56 x 7 ?',
        choices: {
            correct: "38",
            wrong: ["40", "25", "50"]
        }
	}, {
        question_string: '25 + 25 + 67 - 7 ?',
        choices: {
            correct: "110",
            wrong: ["100", "95", "78"]
        }
	}, {
		question_string: '25 x 8 x 5 ?',
		choices: {
			correct: "1000",
			wrong: ["850", "1500", "1250"]
		} 
	}, {
		question_string: '9500 : 2 : 5?',
		choices: {
			correct: "950",
			wrong: ["1050", "850", "1200"]
		}
	}, {
		question_string: '20 x (15 + 15) - 35 ?',
		choices: {
			correct: "565",
			wrong: ["500", "650", "475"]
	}  
