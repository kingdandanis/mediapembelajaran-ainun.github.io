(function($) {
    ...
    var myColor;
    var all_questions = [{
        question_string: "1250 : 5 ? ",
        choices: {
            correct: "250",
            wrong: ["200", "300", "350"]
        }
    }, {
        question_string: "5650 : 2 ?",
        choices: {
            correct: "2825",
            wrong: ["2580", "2850", "2500"]
        }
    }, {
        question_string: "125 : 5 ? ",
        choices: {
            correct: "25",
            wrong: ["20", "35", "30"]
        }
    }, {
        question_string: '900 : 2 : 15 ?',
        choices: {
            correct: "30",
            wrong: ["35", "25", "40"]
        }
    }, {
        question_string: '30500 : 20 ',
        choices: {
            correct: "1525",
            wrong: ["1500", "1650", "1700"]
        }
    }];
